...
<body style="background: #fff; ">
    ...
    <!-- 当前表的 -->
                ...
                <div class="layui-form-item main_borderColor" :style='{"padding":"10px","boxShadow":"0 0 0px rgba(255,0,0,.8)","margin":"0 0 10px 0","backgroundColor":"rgba(255, 255, 255, 0)","borderRadius":"1px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
                    ...
                    <div class="layui-input-block">
                        <input class="layui-input main_borderColor" :style='{"padding":"0 12px","boxShadow":"0 0 0px rgba(160, 67, 26, 1)","backgroundColor":"#fff","color":"rgba(135, 206, 250, 1)","borderRadius":"4px","textAlign":"left","borderWidth":"1px","fontSize":"15px","borderStyle":"solid","height":"40px"}'
                           v-model="detail.yonghuName" lay-verify="required" type="text" :readonly="ro.yonghuName" name="yonghuName" id="yonghuName" autocomplete="off">
                    </div>
                </div>
<!-- 手机号 -->
                <div class="layui-form-item main_borderColor" :style='{"padding":"10px","boxShadow":"0 0 0px rgba(255,0,0,.8)","margin":"0 0 10px 0","backgroundColor":"rgba(255, 255, 255, 0)","borderRadius":"1px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
    ...
    <!-- 身份证号 -->
                <div class="layui-form-item main_borderColor" :style='{"padding":"10px","boxShadow":"0 0 0px rgba(255,0,0,.8)","margin":"0 0 10px 0","backgroundColor":"rgba(255, 255, 255, 0)","borderRadius":"1px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
                    ...
                    <div class="layui-input-block">
                        <div v-if="detail.yonghuPhoto" style="display:inline-block;margin-right:10px;">
                            <img  v-if="detail.yonghuPhoto != null" id="yonghuPhotoImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" :src="baseUrl+detail.yonghuPhoto">
                            <span v-if="detail.yonghuPhoto == null">暂无图片</span>
                ...
                <div class="layui-form-item main_borderColor" :style='{"padding":"10px","boxShadow":"0 0 0px rgba(255,0,0,.8)","margin":"0 0 10px 0","backgroundColor":"rgba(255, 255, 255, 0)","borderRadius":"1px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
                    ...
                    <div class="layui-input-block">
                        <select name="yonghuTypes" id="yonghuTypes" lay-filter="yonghuTypes">
                            <option value="">请选择</option>
                            <option v-for="(item,index) in yonghuTypesList" v-bind:key="index" :value="item.codeIndex" :selected="detail.yonghuTypes == item.codeIndex?true:false" :key="item.codeIndex">{{ item.indexName }}</option>
                        </select>
                    </div>
                </div>
<!-- 邮箱 -->
    ...
    <script>
        ...
        layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
            ...
            localStorage.setItem("goUtl","./pages/yonghu/list.jsp")
           ...
           // 上传文件
            ...
            //修改
            if(http.getParam('yonghuId')){
                http.request(`yonghu/info/${http.getParam('yonghuId')}`, 'get', {}, function(data) {
            ...
            form.on('submit(thisSubmit)', function (data) {
                ...
                if(http.getParam('yonghuId')){
                    data["id"]= http.getParam('yonghuId')
                }
                // 提交数据
                http.requestJson(`yonghu/${http.getParam("yonghuId")?"update":"add"}`, 'post', data, function (res) {
                    if(res.code == 0){
                        layer.msg('提交成功', {
                            time: 2000,
                            icon: 6
                        }, function () {
                            vue.jump("../yonghu/list.jsp");
                                http.remove('yonghuId')
                            // back();
                        });
                    }else{
                        layer.msg(res.msg, {
       ...
       function yonghuTypesSelect() {
           //填充下拉框选项
           layui.http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=yonghu_types", "GET", {}, (res) => {
               if(res.code == 0){
