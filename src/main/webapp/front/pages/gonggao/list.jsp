    ...
    <div class="container py-3">
        ...
        <div class="row">
            ...
            <div style="width: 760px;margin-top: 13px">
                    ...
                    <div v-for="(item,index) in dataList" :key="index" class="list-item4B list-item4" style="margin-top: 5px">
                        <div class="animation-box" @click="jump('../gonggao/detail.jsp?id='+item.id)" style="display: flex; flex-direction: column;"
                             :style='{"boxShadow":"0 0 0px rgba(255,0,0,.8)","borderColor":"rgba(85, 122, 156, 0.64)","backgroundColor":"rgba(255, 255, 255, 0)","borderRadius":"20px","borderWidth":"0","borderStyle":"ridge"}'>
                            <img :style='{"padding":"0 20px","margin":"0 26px 0 0","boxShadow":"0 0 0px rgba(255,0,0,.8)","borderColor":"rgba(190, 190, 190, 0.73)","borderRadius":"10px","borderWidth":"2px","width":"250px","borderStyle":"solid","height":"300px"}'
                                 :src="item.gonggaoPhoto?baseUrl+item.gonggaoPhoto.split(',')[0]:''">
                            <div>
                                <div :style='{"isshow":true,"padding":"5px","backgroundColor":"var(--publicSubColor)","color":"rgba(0, 0, 0, 1)","borderRadius":"0 0 6px 6px","textAlign":"center","width":"90%","fontSize":"16px"}'
                                >{{item.gonggaoName}}
                                </div>
                                <div v-if="item.gonggaoValue"
                                     :style='{"padding":"10px","backgroundColor":"rgba(203, 203, 203, 0.53)","color":"var(--publicMainColor)","borderRadius":"5px 5px 0 0 ","textAlign":"center","width":"90%","fontSize":"18px"}'
                                >{{item.gonggaoValue}}
                                </div>
                            </div>
                        </div>
