    ...
    <div class="container py-3">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 event-right wthree-event-right">
                ...
                <input type="text" v-model="searchForm.yonghuKaoqinUuidNumber" placeholder="考勤唯一编号" autocomplete="off"
                       class="search-input">     
                <input type="text" v-model="searchForm.yonghuKaoqinName" placeholder="考勤标题" autocomplete="off"
                       class="search-input">                                    <div style="display: flex;justify-content: space-evenly;align-items: center;">
                        <div id="btn-search" class="button-submit"><i class="layui-icon layui-icon-search"></i>搜索</div>
                        <div v-if="isAuth('yonghuKaoqin','新增')"  @click="jump('../yonghuKaoqin/add.jsp')" class="button-submit"><i class="layui-icon">&#xe654;</i>添加</div>
                    </div>
                </form>
            </div>
        </div>
