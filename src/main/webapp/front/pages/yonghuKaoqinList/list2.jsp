...
<script type="text/javascript">
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery', 'laydate', 'tinymce'], function() {
        ...
        localStorage.setItem("goUtl","./pages/yonghuKaoqinList/list2.jsp")
        ...
        $(document).on("click", ".thisTableType-search", function (e) {
           ...
           //当前表的 打卡状态 字段 字典表查询方法
           function yonghuKaoqinListTypesSelect() {
               http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=yonghu_kaoqin_list_types", 'get', {}, function (res) {
                   if(res.code == 0){
