...
var centerMenu = [
    ...
    ,{
        name: '实训方向报名',
        url: '../shixunOrder/list.jsp'
    }
    ,{
        name: '学生考勤详情',
        url: '../yonghuKaoqinList/list.jsp'
    }
    ,{
        name: '作业提交',
        url: '../zuoyeTijiao/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '实训方向',
        url: './pages/shixun/list.jsp'
    },
    {
        name: '作业',
        url: './pages/zuoye/list.jsp'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/shixunguanlixitong/admin/dist/index.jsp#/login";
