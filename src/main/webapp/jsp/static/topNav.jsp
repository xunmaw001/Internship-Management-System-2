...
<style>
    ...
    .top-brand .nav .dropdown-menu.profile::before {
        left: 100%;
        margin-left: -28px;
        border-bottom-color: var(--publicMainColor,orange);
    }
...
<div class="container top-brand" style="display: flex;">
    ...
    <nav class="navbar navbar-default">
        <div class="navbar-header">
            <a href="${pageContext.request.contextPath}/index.jsp">实习管理系统</a>
        </div>
        <ul class="nav justify-content-end">
            ...
            <li class="nav-item" style="position: relative;">
                ...
                <div class="dropdown-menu lochana-box-shadow2 profile animated flipInY">
                    <h5></h5>
                        <a class="dropdown-item web" href="#" onclick="toFront()"><span class="ti-power-off"></span><span class="text">跳到前台</span></a>
                    <a class="dropdown-item exit" href="#" onclick="logout()"><span class="ti-power-off"></span><span class="text">退出</span></a>
                </div>
            </li>
        </ul>
