                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 gonggaoTypesDiv">
                                        <label>公告类型</label>
                                        <select style="width: 450px" id="gonggaoTypesSelect" name="gonggaoTypes" class="form-control"></select>
                                    </div>
...
<script>
    ...
    function upload() {
        ...
        $('#gonggaoPhotoupload').fileupload({
            ...
            dataType: 'json',
                ...
                document.getElementById('gonggaoPhotoImg').setAttribute('src',baseUrl+photoUrl);
    ...
    <!-- 初始化当前表的下拉框 -->
        function initializationGonggaoTypesSelect(){
            ...
            if(gonggaoTypesSelect != null && gonggaoTypesOptions != null  && gonggaoTypesOptions.length > 0 ){
                gonggaoTypesSelect.options.length=0;
    ...
    function getContent() {
        ...
        if($("#gonggaoContentupload").length>0) {
            ...
            if (gonggaoContentEditor.hasContents()) {
                $('#gonggaoContent-input').attr('value', gonggaoContentEditor.getContent().replaceAll(baseUrl,""));
            }
        }
    }
    function jiaofei() {
    ...
    function getDetails() {
        ...
        if (addgonggao != null && addgonggao != "" && addgonggao != "null") {
            ...
            $('#submitBtn').text('修改');
            if(window.sessionStorage.getItem('accountTableName') =='gonggao'){
    ...
    function showImg() {
        <!--  当前表的图片  -->
        $("#gonggaoPhotoImg").attr("src",baseUrl+ruleForm.gonggaoPhoto);
