                                ...
                                <input id="laoshiId" name="laoshiId" v-model="ruleForm.laoshiId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="chengjiName" name="chengjiName" class="form-control"
                                               v-model="ruleForm.chengjiName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="chengjiUuidNumber" name="chengjiUuidNumber" class="form-control"
                                               v-model="ruleForm.chengjiUuidNumber" readonly>
                                    </div>

                                <div class="form-group col-md-6">
                                    <label>成绩照片</label>
                                    <img id="chengjiPhotoImg" width="100" height="100">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="chengjiFenshu" name="chengjiFenshu" class="form-control"
                                               v-model="ruleForm.chengjiFenshu" readonly>
                                    </div>
