            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">分班登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="shixunId" name="shixunId" v-model="ruleForm.shixunId" readonly type="hidden">

                                    <div class="form-group col-md-6">
                                        <label>分班名称</label>
                                        <input style="width: 450px" id="fenbanName" name="fenbanName" class="form-control"
                                               v-model="ruleForm.fenbanName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="fenbanUuidNumber" name="fenbanUuidNumber" class="form-control"
                                               v-model="ruleForm.fenbanUuidNumber" readonly>
                                    </div>

                                <div class="form-group col-md-6">
                                    <label>分班照片</label>
                                    <img id="fenbanPhotoImg" width="100" height="100">
                                </div>

                                <div class="form-group col-md-6">
                                    <label>分班类型</label>
                                    <input style="width: 450px" id="fenbanValue" name="fenbanValue" class="form-control"
                                           v-model="ruleForm.fenbanValue" readonly>
                                </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.fenbanContent != null && ruleForm.fenbanContent != 'null' && ruleForm.fenbanContent != '') {
            var fenbanContentUeditor = UE.getEditor('fenbanContentEditor');
                fenbanContentUeditor.ready(function () {
                    ...
                    fenbanContentUeditor.setDisabled('fullscreen');
            });
        }
    }
