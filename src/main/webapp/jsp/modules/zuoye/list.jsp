...
<!--/Pre Loader -->
                        ...
                        <div class="widget-area-2 lochana-box-shadow">
                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <label>作业名称</label>
                                        <input type="text" id="zuoyeNameSearch" placeholder="请输入作业名称" aria-controls="tableId" class="form-control form-control-sm">
                                                                                                             
                                        <label>作业类型</label>
                                        <select name="zuoyeTypesSelectSearch" id="zuoyeTypesSelectSearch" aria-controls="tableId" class="form-control form-control-sm"></select>
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="zuoyeExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/zuoyeMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('zuoye_name')">作业名称<i id="zuoyeNameIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('zuoye_uuid_number')">作业编号<i id="zuoyeUuidNumberIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('zuoye_photo')">作业封面<i id="zuoyePhotoIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('zuoye_types')">作业类型<i id="zuoyeTypesIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('zuoye_file')">作业下载<i id="zuoyeFileIcon" class="fa fa-sort"></i></th>
    ...
    <script>
        ...
        function upload() {
            /*导入数据*/
            $('#zuoyeExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("zuoye/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
