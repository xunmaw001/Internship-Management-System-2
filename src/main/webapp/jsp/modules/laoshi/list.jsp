...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">任课老师管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">任课老师管理</li>
                            <li class="breadcrumb-item active">任课老师列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">任课老师列表</h3>
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="laoshiExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/laoshiMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('laoshi_name')">老师姓名<i id="laoshiNameIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('laoshi_phone')">老师手机号<i id="laoshiPhoneIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('laoshi_id_number')">老师身份证号<i id="laoshiIdNumberIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('laoshi_photo')">老师头像<i id="laoshiPhotoIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('sex_types')">性别<i id="sexTypesIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('laoshi_email')">电子邮箱<i id="laoshiEmailIcon" class="fa fa-sort"></i></th>
                                        <th>操作</th>
                                    </tr>
                                    </thead>
                                    <tbody id="thisTbody">
    ...
    <!-- 本表的查询条件 -->
        ...
        function upload() {
            /*导入数据*/
            $('#laoshiExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("laoshi/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
