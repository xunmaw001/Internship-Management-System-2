...
<style>
    ...
    body {
        ...
        width: 100%;
        height: 100%;
        background-image: url('/shixunguanlixitong/img/back-img-bg.jpg') !important;
    }
    .container {
        padding: 0;
        margin: 0;
        ...
        <div class="" id="login-wrapper">
            <h1>注册</h1>
               ...
               <div class="form-group">
                   ...
                   <input id="laoshiName" name="laoshiName" class="form-control-i"
                          placeholder="老师姓名">
               </div>
               <div class="form-group">
                   <label class="label">老师手机号</label>
                   <input id="laoshiPhone" name="laoshiPhone" class="form-control-i"
                          onchange="phoneChickValue(this)"  placeholder="老师手机号">
               </div>
               <div class="form-group">
                   <label class="label">老师身份证号</label>
                   <input id="laoshiIdNumber" name="laoshiIdNumber" class="form-control-i"
                          onchange="idNumberChickValue(this)"  placeholder="老师身份证号">
               </div>
               <div class="form-group">
               ...
               <div class="form-group">
                   ...
                   <input id="laoshiEmail" name="laoshiEmail" class="form-control-i"
                          placeholder="电子邮箱">
               </div>
    ...
    <script>
        ...
        $('#laoshiPhotoupload').fileupload({
            ...
            dataType: 'json',
                ...
                document.getElementById('laoshiPhotoImg').setAttribute('src',baseUrl+photoUrl);
