    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑任课老师</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑任课老师</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">任课老师信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 laoshiIdNumberDiv">
                                        <label>老师身份证号</label>
                                        <input style="width: 450px" id="laoshiIdNumber" name="laoshiIdNumber" class="form-control"
                                               onchange="laoshiIdNumberChickValue(this)"  placeholder="老师身份证号">
                                    </div>
...
<script>
    ...
    function getDetails() {
        ...
        if (addlaoshi != null && addlaoshi != "" && addlaoshi != "null") {
            ...
            $('#submitBtn').text('修改');
            if(window.sessionStorage.getItem('accountTableName') =='laoshi'){
