            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">学生考勤详情登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="yonghuKaoqinId" name="yonghuKaoqinId" v-model="ruleForm.yonghuKaoqinId" readonly type="hidden">

                                <div class="form-group col-md-6">
                                    <label>打卡状态</label>
                                    <input style="width: 450px" id="yonghuKaoqinListValue" name="yonghuKaoqinListValue" class="form-control"
                                           v-model="ruleForm.yonghuKaoqinListValue" readonly>
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "yonghuKaoqinList/info/" + id,
