                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 yonghuIdNumberDiv">
                                        <label>用户身份证号</label>
                                    ...
                                    <div class="form-group col-md-6 yonghuTypesDiv">
                                        <label>实训方向</label>
                                        <select style="width: 450px" id="yonghuTypesSelect" name="yonghuTypes" class="form-control"></select>
                                    </div>
...
<script>
    ...
    <!-- 初始化当前表的下拉框 -->
        ...
        function initializationYonghuTypesSelect(){
            ...
            if(yonghuTypesSelect != null && yonghuTypesOptions != null  && yonghuTypesOptions.length > 0 ){
                yonghuTypesSelect.options.length=0;
    ...
    function getDetails() {
        ...
        if (addyonghu != null && addyonghu != "" && addyonghu != "null") {
            ...
            $('#submitBtn').text('修改');
            if(window.sessionStorage.getItem('accountTableName') =='yonghu'){
