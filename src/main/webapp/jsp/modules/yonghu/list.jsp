...
<!--/Pre Loader -->
                        ...
                        <div class="widget-area-2 lochana-box-shadow">
                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="yonghuExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/yonghuMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('yonghu_name')">用户姓名<i id="yonghuNameIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('yonghu_phone')">用户手机号<i id="yonghuPhoneIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('yonghu_id_number')">用户身份证号<i id="yonghuIdNumberIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('yonghu_photo')">用户头像<i id="yonghuPhotoIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('sex_types')">性别<i id="sexTypesIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('yonghu_types')">实训方向<i id="yonghuTypesIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('yonghu_email')">电子邮箱<i id="yonghuEmailIcon" class="fa fa-sort"></i></th>
                                        <th>操作</th>
                                    </tr>
                                    </thead>
                                    <tbody id="thisTbody">
    ...
    <!-- 本表的查询条件 -->
        ...
        function upload() {
            /*导入数据*/
            $('#yonghuExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("yonghu/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
