    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑打卡状态</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">打卡状态管理</li>
                        <li class="breadcrumb-item active">编辑打卡状态</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">打卡状态表信息</h3>
...
<script>
    ...
    var tableName = "dictionaryYonghuKaoqinList";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            data["dicCode"] = "yonghu_kaoqin_list_types";
            data["dicName"] = "打卡状态";
            ...
            httpJson("dictionary/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    ...
                    window.sessionStorage.removeItem('superId');
                    let flag = true;
                    if (flag) {
                        layui.layer.msg(successMes, {time: 2000,icon: 6});
                    }
    ...
    function getDetails() {
        ...
        if (adddictionary != null && adddictionary != "" && adddictionary != "null") {
            ...
            $(validform());
            $('#submitBtn').text('新增');
            httpJson("dictionary/maxCodeIndex" , "POST", {"dicCode":"yonghu_kaoqin_list_types"}, (res) => {
                if(res.code == 0){
    ...
    function compare() {
        ...
        if (largerVal != null && smallerVal != null) {
            if (largerVal <= smallerVal) {
                layui.layer.msg(smallerName + '不能大于等于' + largerName, {time: 2000,icon: 5});
                return false;
            }
        }
        return true;
